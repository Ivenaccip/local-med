# Guillermo Leonardo Montaño Medina — Platanus Build Night — Ciudad de México Project
...
- Guillermo Leonardo Montaño Medina ([@Ivenaccip](https://github.com/Ivenaccip))
...
2. Point your local `origin` at **both** repos, so a single `git push` updates each one:
   ...
   git remote set-url --add --push origin https://github.com/platanus-build-night/platanus-build-night-26-mx-Ivenaccip.git
